			...
			<div class="container">
				<div class="row mt-3">
					<div
						...
						<span class="sub-title">Fine Arts and Athletics Board</span>
					</div>
				</div>
			</div>
		</section>
						...
						<article class="post post-large blog-single-post border-0 m-0 p-0">
							...
							<div class="post-content ml-0">
								...
								<h2 class="font-weight-bold">
									<a href="blog-post.html">실용음악과 윤기훈입니다. 같이 코노 가실 분 계신 가요?.</a>
								</h2>
										...
										<li>
											<div class="comment">
												...
												<div class="comment-block">
													...
													<span class="comment-by"> <strong>이성호</strong> <span

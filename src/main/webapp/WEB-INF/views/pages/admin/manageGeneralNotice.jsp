												...
												<c:forEach var="n" items="${list}">
													...
													<c:choose>
														<c:when test="${nSecret == 'N' }">
															<tr>
																<td>${n.nId }</td>
																<td><c:url var="nDetail" value="manageNoticeDetail.do">
																		<c:param name="nId" value="${n.nId }" />
																		<c:param name="currentPage" value="${ pi.currentPage }" />
																		<c:param name="nType" value="${n.nType }" />
																	</c:url> <a id="ntitle" href=${ nDetail}>${n.nTitle }</a></td>
														...
														<c:when test="${admin!=null}">
															<tr>
																...
																<td><c:url var="nDetail" value="manageNoticeDetail.do">
																		...
																		<c:param name="currentPage" value="${ pi.currentPage }" />
																		<c:param name="nType" value="${n.nType }" />
																	</c:url> <c:if test="${nSecret eq 'N'}">
																		<a id="ntitle" href="${nDetail}"> ${n.nTitle } </a>
																	</c:if> <c:if test="${nSecret eq 'Y'}">
																		<a id="ntitle" href="${nDetail}"> <span style="color: red">(비밀글)</span>${n.nTitle }
																		</a>
																	</c:if></td>

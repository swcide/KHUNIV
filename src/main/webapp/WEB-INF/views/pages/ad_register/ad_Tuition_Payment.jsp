...
<body onresize="parent.resizeTo(800,750)" onload="parent.resizeTo(700,100)">
	<div class="body">
					...
					<div class="row">
						...
						<div class="col-md-7 align-self-center p-static order-2 text-center">
							<h1 class="text-dark text-uppercase float-left">
								<strong style="color: white;">등록금 납부</strong>
							</h1>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col">
						<table class="table table-hover">
							<tbody>
								<tr>
									<th colspan="2">신청 학점</th>
									<td colspan="2">(6/12)</td>
								</tr>
								<tr>
									<th colspan="2">등록금(수업료)</th>
								...
								<tr>
									<th colspan="2">납부할 금액</th>
									<td colspan="2">480,000원</td>
								</tr>
								<tr>
									<th colspan="2">납부 계좌</th>
						...
						<table class="table table-hover">
							<tbody>
								<tr>
									<th colspan="2">납부 방법</th>
								</tr>
								<tr>
									<td colspan="2">- 등록금 납부는 하나의 결제수단으로 한번에 결제해야 합니다.</td>
								<tr>
									<td colspan="2">(현금 과 신용카드 동시 사용 불가, 두 개 이상의 카드로 결제 불가)</td>
								</tr>
								<tr>
									<td colspan="2">- 신용카드로 등록금 납부 시 등록 기간 이후 결제취소는 불가합니다.</td>
								</tr>
							</tbody>
						</table>

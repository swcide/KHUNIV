				...
				<div class="col-lg-9 order-1 order-lg-2" style="padding-left: 40px; padding-right: 40px;">
					...
					<div class="col-lg-6 mb-lg-0">
						...
						<ul class="list list-icons list-primary list-borders">
							...
							<li><i class="fas fa-check"></i><a href="resources/AbsenceUploadFile/파일명" download="파일명"> 자퇴 신청서 다운로드 </a></li>
							<li><i class="fas fa-check"></i>파일명 예시) 자퇴_체육학과_윤기훈.</li>
					...
					<div class="col-lg-6 mb-4 mb-lg-0">
						<div class="form-check form-check-inline">
							...
							<label class="font-weight-bold text-dark text-3 float-center" style="margin: 0;">정말 자퇴 신청을 하시겠습니까?</label>
						</div>
					</div>
					<div class="form-group col-md-12">
						<hr>

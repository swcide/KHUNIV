							...
							<div class="col-lg-12">
								<div class="tabs">
									...
									<div class="tab-content">
										...
										<div align="right">
										<button type="button" class="btn btn-primary btn-xs mb-2" onClick="window.open(this.href='ad_return_absence.do', '', 'resizable=yes, width=900, height=800 left=700px top=100px'); return false;">복학신청 바로가기</button>
										</div>
									</div>
								</div>
							</div>

...
<body>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col p-static">
							<h1 data-title-border>자퇴신청확인</h1>
						</div>
					</div>
				</div>
			</section>
							...
							<div class="col-lg-12">
								<div class="tabs">
									<ul class="nav nav-tabs nav-justified flex-column flex-md-row">
										<li class="nav-item active"><a class="nav-link">자퇴신청상태</a></li>
									</ul>
									<div class="tab-content">
											...
											<table class="table table">
												...
												<tbody>
													<tr>
														...
														<c:if test="${view.expStatus eq 'N' || empty view.expStatus }">
															<td style="text-align: center;">
																<span class="badge badge-primary badge-md" style="padding: 5px;">미신청</span>
															</td>
														</c:if>
														<c:if test="${view.expStatus eq 'Y'}">
															<td style="text-align: center;">
										...
										<button type="button" class="btn btn-primary btn-xs mb-2" onClick="openNew()">자퇴신청 바로가기</button>
										</div>
									</div>
								</div>
							</div>
	...
	function openNew() {
		var sNo = $('#sNo').val();
		console.log(sNo)
		window.open(this.href='ad_drop_absence.do?sNo='+ sNo, '', 'resizable=yes, width=900, height=800 left=700px top=100px'); 
	return false;

			...
			<div id="pdf_wrap">
				<div class="container py-2">
					<div class="row" style="border: 1px solid;">
						<div class="col">
							<h1 align="center" style="font-weight: bolder; margin-top: 30px;">졸업 증명서</h1>
							<div class="row">
								<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-12" align="center" style="margin-bottom: 20px; background-image: url(resources/img/seal.png); background-size: contain; background-repeat: no-repeat; background-position: 70%;">
				...
				<button id="create_pdf" class="btn btn-primary btn-lg mb-2 float-right" style="margin-right: 40px; margin-top: 5px;">다운로드</button>
			</div>
		</div>
	</div>
	<script>

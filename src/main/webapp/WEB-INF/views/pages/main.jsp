			...
			<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'delay': 9000, 'gridwidth': 1170, 'gridheight': 650, 'disableProgressBar': 'on', 'responsiveLevels': [4096,1200,992,500], 'navigation' : {'arrows': { 'enable': true, 'style': 'arrows-style-1 arrows-big arrows-dark' }, 'bullets': {'enable': false, 'style': 'bullets-style-1 bullets-color-primary', 'h_align': 'center', 'v_align': 'bottom', 'space': 7, 'v_offset': 70, 'h_offset': 0}}}">
				<ul>
					...
					<li data-transition="fade"><img src="resources/img/slides/need_bg_3.jpg" alt="" data-bgposition="right center" data-bgpositionend="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-kenburns="on" data-duration="9000" data-ease="Linear.easeNone" data-scalestart="110" data-scaleend="100" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="0" class="rev-slidebg">
						...
						<div class="tp-caption font-weight-light text-color-light" data-frames='[{"from":"opacity:0;","speed":300,"to":"o:1;","delay":2000,"split":"chars","splitdelay":0.05,"ease":"Power2.easeInOut"},{"delay":"wait","speed":1000,"to":"y:[100%];","mask":"x:inherit;y:inherit;s:inherit;e:inherit;","ease":"Power2.easeInOut"}]' data-x="center" data-y="center" data-fontsize="['18','18','18','50']" data-lineheight="['20','20','20','55']" style="color: #b5b5b5;">KHCU | KH Cyber University</div></li>
				</ul>
			</div>
		</div>
		<!-- 공지사항 탑5 세션 -->
							...
							<!-- 학사공지 -->
								<div class="tab-pane active" id="tabsNavigationSimple1">
									<div class="text-center">
											...
											<tbody>
												<c:forEach var="n" items="${nList}">
													...
													<c:if test="${nType eq 1}">
														<tr>
															<td>${n.nId}</td>
															<td><c:url var="nDetail" value="nDetail.do">
																	<c:param name="nId" value="${n.nId}" />
																	<c:param name="currentPage" value="${ pi.currentPage }" />
																	<c:param name="nType" value="${n.nType }" />
																</c:url> <a class="ntitle" href="${nDetail}">${n.nTitle}</a></td>
																<c:url var="deptNotice" value="nList.do">
																	<c:param name="nType" value="1" />
																	</c:url>
															<td>${n.nName }</td>
															<td>${n.nCount}</td>
															<td>${n.nCreateDate}</td>
										...
										<!-- 학사공지로 이동 -->
										<a type="button" class="btn btn-quaternary btn-with-arrow mb-2 float-right" href="${deptNotice }">
											학사 공지 더보기<span><i class="fas fa-chevron-right"></i></span>
										</a>
									</div>
								</div>
								<script>
								...
								<div class="tab-pane" id="tabsNavigationSimple2">
									<div class="text-center">
													...
													<c:if test="${nType eq 2}">
														<tr>
															...
															<td><c:url var="nDetail" value="nDetail.do">
																	<c:param name="nId" value="${n.nId}" />
																	<c:param name="currentPage" value="${ pi.currentPage }" />
																	<c:param name="nType" value="2"/>
																</c:url> <a class="ntitle" href="${nDetail}">${n.nTitle}</a></td>
																<c:url var="generNotice" value="nList.do">
																	<c:param name="nType" value="2" />
																	</c:url>
															<td>${n.nName }</td>
															<td>${n.nCount}</td>
										...
										<!-- 일반공지로 이동 -->
										<a type="button" class="btn btn-quaternary btn-with-arrow mb-2 float-right" href="${generNotice }">
											일반 공지 더보기<span><i class="fas fa-chevron-right"></i></span>
										</a>
									</div>
								</div>
							</div>
			...
			<div class="container">
				<div class="row align-items-center justify-content-center">
					<div class="col-lg-6 pb-sm-4 pb-lg-0 pr-lg-5 mb-sm-5 mb-lg-0">
						...
						<!-- 취업센터 바로가기 -->
						<a href="emp.do" class="btn btn-dark font-weight-semibold btn-px-4 btn-py-2 text-2">바로가기</a>
					</div>
									...
									<div class="col-lg-6">
										...
										<div class="embed-responsive-borders">
											<div class="embed-responsive embed-responsive-16by9">
												<iframe width="1280" height="720" src="https://www.youtube.com/embed/6unAuypsb4g" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
											</div>
										</div>
									</div>
									<div class="col-lg-6">
										...
										<div class="embed-responsive-borders">
											<div class="embed-responsive embed-responsive-16by9">
												<iframe width="1280" height="720" src="https://www.youtube.com/embed/WRAGadf1WyI" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
											</div>
										</div>
									</div>
								</div>

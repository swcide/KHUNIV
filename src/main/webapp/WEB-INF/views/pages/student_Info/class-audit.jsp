					...
					<div class="card">
						...
						<div class="card-header p-2">
							<ul class="nav nav-pills">
								<li class="nav-item"><a class="btn disabled" href="" data-toggle="tab"><strong>청강 신청</strong></a></li>
								<li class="nav-item"><a class="nav-link active" href="#activity1" data-toggle="tab">청강 가능 과목</a></li>
							</ul>
						</div>
						<!-- /.card-header -->
						<div class="card-body">
									...
									<div class="post">
										...
										<div class="row">
											<div class="col-12 table-responsive">
												...
												<div align="left">
													<label class="text-danger">※청강은 1개만 신청 가능하며 담담 교수가 거절할 수 있음을 숙지하시길 바랍니다.</label>
												</div>
												<div align="right">
													<button class="btn btn-outline-primary btn-flat" style="margin-top: -75px;">신청하기</button>
												</div>
											</div>
											<!-- /.col -->
										</div>

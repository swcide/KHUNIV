					...
					<div class="image-hotspots">
						<div class="row">
								...
								<article class="post post-medium border-0 pb-0 mb-5">
									...
									<div class="post-content">
										...
										<h2
											...
											<span>${lc.className }</span>
										</h2>

										<p>${lc.className }${lc.className }${lc.className }${lc.className }${lc.className }${lc.className }${lc.className }${lc.className }
											${lc.className }${lc.className }${lc.className }${lc.className }${lc.className }${lc.className }${lc.className }${lc.className }
										</p>
											
											
										<div class="post-meta">
											<span><i class="far fa-user"></i> 교수: ${lc.profName } </span> <span><i
												class="far fa-folder"></i> 수강대상: ${lc.deptName } </span> <span><i
												class="far fa-comments"></i> <a href="#">${lc.profEmail }</a></span>
							...
							<div class="col-md-4 col-lg-3">
								<article class="post post-medium border-0 pb-0 mb-5">
									<div class="post-image">
										<a href="prof_lectureVideoList.do"> <img
											src="resources/img/컴퓨터네트워킹.jpg"
											class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0"
											alt="강의이미지" />
										</a>

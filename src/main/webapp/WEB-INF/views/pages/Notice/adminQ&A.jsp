				...
				<div class="col-md-10">
					...
					<div class="card card-outline card-tabs">
						...
						<div class="card-header ui-sortable-handle">
							<h3 class="card-title">
								<i class="ion ion-clipboard mr-1"></i>Q&A
							</h3>
						</div>
						<div class="card-body">
											...
											<table class="table table-striped">
												...
												<tbody>
													...
													<tr>
														<td>2</td>
														<td><span class="badge bg-primary">답변완료</span></td>
														<td><a href="Q&Aread.jsp">[비밀글] 안녕하십니까 대학탐방과 관련해서
																질문드립니다.</a></td>
														<td>비밀글</td>
														<td>2020-09-03</td>
													</tr>
													<tr>
														<td>1</td>
														<td><span class="badge bg-primary">답변완료</span></td>
														<td><a href="Q&Aread.jsp">학사 편입학 공인영어 질문</a></td>
														<td>이성호</td>
														<td>2020-09-01</td>
													</tr>
												</tbody>
						...
						<div class="card-tools" align="center">
							<ul class="pagination pagination-sm" style="display: inline-flex">
								...
								<!-- 	<li class="page-item"><a href="#activity2" class="page-link">2</a></li>

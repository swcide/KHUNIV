						...
						<div class="header-column">
							<div class="header-row">
								<div class="header-logo">
									<a href="index.html"> <img alt="Porto" width="100"
							...
							<div class="header-row">
											...
											<ul class="nav nav-pills" id="mainNav">
												<li class="dropdown"><a
													class="dropdown-item dropdown-toggle" href="index.html">
														학교 소개 </a></li>
												<li class="dropdown"><a
													class="dropdown-item dropdown-toggle" href="#"> 학사 안내 </a>
													<ul class="dropdown-menu">
														<li><a class="dropdown-item"
															href="page-custom-header.html">수강 신청 안내</a></li>
														<li class="dropdown-submenu"><a class="dropdown-item"
															href="#">학적 관리</a>
															<ul class="dropdown-menu">
																<li><a class="dropdown-item"
																	href="about-us-advanced.html">휴학 안내</a></li>
																<li><a class="dropdown-item" href="about-us.html">복학
																		안내</a></li>
																<li><a class="dropdown-item" href="about-me.html">자퇴
																		안내</a></li>
																<li><a class="dropdown-item" href="about-me.html">복학
																		안내</a></li>
																<li><a class="dropdown-item" href="about-me.html">졸업
																		유예 안내</a></li>
																<li><a class="dropdown-item" href="about-me.html">장학금
																		안내</a></li>
																<li><a class="dropdown-item" href="about-me.html">등록금
																		납부 안내</a></li>
															</ul></li>
													</ul></li>
												<li class="dropdown"><a
													class="dropdown-item dropdown-toggle" href="#"> 대학 생활 </a>
													<ul class="dropdown-menu">
														<li class="dropdown-submenu"><a class="dropdown-item"
															href="#">취업지원센터</a>
															<ul class="dropdown-menu">
																<li><a class="dropdown-item"
																	href="feature-headers-overview.html">취업지원센터 바로가기</a></li>
															</ul></li>
														...
														<li class="dropdown-submenu"><a class="dropdown-item"
															...
															<ul class="dropdown-menu">
																<li class="dropdown-submenu"><a
																	class="dropdown-item" href="#">계열별 게시판</a>
																	<ul class="dropdown-menu">
																		<li><a class="dropdown-item"
																			href="feature-page-headers-classic-small.html">인문
																				사회 계열</a></li>
																		<li><a class="dropdown-item"
																			href="feature-page-headers-classic-medium.html">자연
																				과학 계열</a></li>
																		<li><a class="dropdown-item"
																			href="feature-page-headers-classic-large.html">공학
																				계열</a></li>
																		<li><a class="dropdown-item"
																			href="feature-page-headers-classic-large.html">예체능
																				계열</a></li>
																	</ul></li>
																<li class="dropdown-submenu"><a
																	class="dropdown-item" href="#">취업정보 게시판</a>
																	<ul class="dropdown-menu">
																		<li><a class="dropdown-item"
																			href="feature-page-headers-modern-small.html">구인
																				공고</a></li>
																		<li><a class="dropdown-item"
																			href="feature-page-headers-modern-large.html">학생
																				이모저모</a></li>
																	</ul></li>
															</ul></li>
													</ul></li>
												<li class="dropdown"><a
													class="dropdown-item dropdown-toggle" href="#"> 상담 안내 </a>
													<ul class="dropdown-menu">
														<li class="dropdown-submenu"><a class="dropdown-item"
															href="#">상담센터</a>
															<ul class="dropdown-menu">
												...
												<li class="dropdown"><a
													class="dropdown-item dropdown-toggle" href="#"> 공지사항 </a>
													<ul class="dropdown-menu">
								...
								<div
									...
									<div
										...
										id="headerAccount">
										<a href="#" class="header-nav-features-toggle"> <i
											class="far fa-user"></i> 김진태
										</a>
										<div
											...
											<div class="row">
												<div class="col-8">
													...
													<p>
														<strong class="text-color-dark text-4">김진태 님</strong>
													</p>
												</div>
												<div class="col-4">
												...
												<div class="col">
													<ul class="nav nav-list-simple flex-column text-3">
														<li class="nav-item"><a class="nav-link" href="#">내
																정보</a></li>
														<li class="nav-item"><a
															class="nav-link border-bottom-0" href="#">로그아웃</a></li>
													</ul>
												</div>
											</div>
										</div>
								...
								<button
									class="header-nav-features header-nav-features-no-border header-nav-features-lg-show-border order-1 order-lg-2 btn btn-outline btn-primary  btn-with-arrow">
					...
					<div class="container py-2">
						<div class="row py-4">
							<div
								...
								<a href="index.html" class="logo pr-0 pr-lg-3"> <img
									alt="Porto Website Template" src="img/logo-footer.png"
									class="opacity-5" height="33">
								</a>
							</div>
							<div
								class="col-lg-7 d-flex align-items-center justify-content-center justify-content-lg-start mb-4 mb-lg-0">
								<p>© Copyright 2020. KH Information Educational Institute.
									All Rights Reserved. 02)111-2222</p>
							</div>
							<div
								...
								<nav id="sub-menu">
									<ul>
										<li><i class="fas fa-angle-right"></i><a
											href="page-faq.html" class="ml-1 text-decoration-none">
												FAQ's</a></li>
										<li><i class="fas fa-angle-right"></i><a
											href="sitemap.html" class="ml-1 text-decoration-none">
												Sitemap</a></li>
										<li><i class="fas fa-angle-right"></i><a
											href="contact-us.html" class="ml-1 text-decoration-none">
												Contact Us</a></li>
									</ul>
								</nav>
							</div>
											...
											<nav class="collapse header-mobile-border-top">
												<ul class="nav nav-pills" id="mainNav">
													...
													<li class="dropdown">
														...
														<ul class="dropdown-menu">
															<li class="dropdown-submenu">
																<a class="dropdown-item" href="#">정기 시험</a>
																<ul class="dropdown-menu">
															...
															<li class="dropdown-submenu">
																<a class="dropdown-item" href="#">수시 시험</a>
																<ul class="dropdown-menu">
													...
													<li class="dropdown">
														<a class="dropdown-item dropdown-toggle" href="el.do">
															E-LIBRARY
														</a>
														<ul class="dropdown-menu">
															<li>
																<a class="dropdown-item" href="el.do">도서 목록</a>
															</li>
															<li>
																<a class="dropdown-item" href="el.do">도서 대여 현황</a>
															</li>
														</ul>
													</li>
													<li class="dropdown">

				...
				<div class="container" style="padding-top: 140px;">
					...
					<div class="row">
						<div class="col text-center">
							<h2 class="font-weight-normal text-7 mb-2"><strong class="font-weight-extra-bold">E-Library Website is Coming Soon</strong></h2>
							<p class="mb-0 lead">거의 다 되었습니당 ^^ 조금만 더 기둘 ^^ 부탁 ^^</p>
							<p class="mb-1">ㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋ</p>
						</div>
					</div>
					<div class="row">
						<div class="col">

						...
						<div class="card-header p-2">
							<ul class="nav nav-pills">
								...
								<li class="nav-item"><a class="nav-link active"
									href="#activity1" data-toggle="tab">온라인 강의</a></li>
						...
						<div class="card-body">
							<div class="tab-content">
								...
								<div class="active tab-pane" id="activity1">
										...
										<div class="col-4 table-responsive">
											<div>
												<div class="timeline-item">
													<span class="time"><i class="fas fa-clock"></i>2020-09-28
														~ 2020-10-3</span>

													<h3 class="timeline-header">
														<a href="#">특강 - 미래사회와 인문학</a>
													</h3>

													<div class="timeline-body">
														<div class="embed-responsive embed-responsive-16by9">
															<iframe class="embed-responsive-item"
																src="https://www.youtube.com/embed/pF4mgiJly0c"
									...
									<P>
										일정한 주제를 채택하여 각 학생이 짧게 발표할 수 있도록 영어로 대화할 때 사용되는 언어기능, 전략 등에 대해
										공부한다.<br> 토론방, 조별 활동 등을 통해 학생들 간의 역할 분담 등의 방법을 이용하여 영어로
										대화하는 방법을 지도한다.
									</P>
								...
								<div align="center" style="padding-bottom: 20px;">
									<button onclick="location= 'specialLecture.jsp'" type="button"
										class="btn btn-primary" data-toggle="modal"
										data-target="#modal-default">목록으로</button>
								</div>

				...
				<div>
					...
					<div class="card" style="width: 180%; margin-left: 5%;">
						...
						<div class="card-header p-2">
							<p style="margin-top: 5px;">&nbsp;&nbsp;&nbsp;※ 계열별 게시판</p>
							<ul class="nav nav-pills">
								<li class="nav-item"><a class="nav-link active"
									href="#activity1" data-toggle="tab">자연과학</a></li>
						...
						<div class="card-body">
							<div class="tab-content">
								...
								<div class="active tab-pane" id="activity1">
									...
									<a href="../insert.jsp" style="float: right; margin-right: 15px;">글	 작성하기</a>

...
<link rel="stylesheet"
	href="resources/vendor/simple-line-icons/css/simple-line-icons.min.css">
<link rel="stylesheet"
...
<link rel="stylesheet"
	href="resources/vendor/magnific-popup/magnific-popup.min.css">
...
<!-- Current Page CSS -->
<link rel="stylesheet"
	href="resources/vendor/rs-plugin/css/settings.css">
<link rel="stylesheet" href="resources/vendor/rs-plugin/css/layers.css">
<link rel="stylesheet"
	href="resources/vendor/rs-plugin/css/navigation.css">
...
<body class="alternative-font-4 loading-overlay-showing"
	data-loading-overlay data-plugin-section-scroll
	data-plugin-options="{'targetClass': '.section-scroll', 'dotsClass': 'section-scroll-dots-navigation-colored', 'changeHeaderLogo': true, 'headerLogoDark': 'resources/img/khculogo4.png', 'headerLogoLight': 'resources/img/khculogo4.png'}">
	...
	<div class="body bg-dark">
						...
						<div class="header-column justify-content-end">
							<div class="header-row">
								<div
									...
									<div
										class="header-nav-main header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-transition header-nav-main-effect-2 header-nav-main-sub-effect-1 px-3">
										<nav class="collapse">
		...
		<div role="main" class="main">
			<section
				class="section section-scroll section-background border-0 p-0 m-0"
				data-section-scroll-title="SECTION 1"
				data-section-scroll-header-color="light">
				<div
					class="position-absolute w-100 h-100 top-0 left-0 appear-animation"
					data-appear-animation="slideInUp"
					style="background-image: url(resources/img/bg-corporate-20-1.jpg); background-size: cover; background-position: center;"></div>
				<div class="container-fluid h-100">
					<div class="row h-100">
						<div class="col-md-6 p-0">
							...
							<div class="row h-100">
								<div
									class="col-12 bg-secondary h-50 p-0 px-4 px-lg-0 appear-animation"
											...
											<div class="row">
												...
												<div ></div>
													...
													<h1
														...
														KH 사이버 대학교에 <br> 오신 것을 환영합니다.
													</h1>
													<a href="main.do"
														class="btn btn-dark font-weight-bold text-3 rounded-0 px-5 btn-py-3 align-items-center d-inline-flex">홈페이지로
								...
								<div
									class="col-12 bg-primary h-50 p-0 px-4 px-lg-0 appear-animation"
									data-appear-animation="fadeInRightShorter"

	...
	<div class="body bg-dark">
						...
						<div class="header-column">
							<div class="header-row">
								<div class="header-logo">
									<a href="">
										<img alt="Porto" width="140" height="40" src="resources/img/khculogo4.png">
									</a>
								</div>
							</div>
						</div>
		...
		<div role="main" class="main">
			<section class="section section-scroll section-background border-0 p-0 m-0" data-section-scroll-title="SECTION 1" data-section-scroll-header-color="light">
				<div class="position-absolute w-100 h-100 top-0 left-0 appear-animation" data-appear-animation="slideInUp" style="background-image: url(resources/img/bg-corporate-20-1.jpg); background-size: cover; background-position: center;"></div>
									...
									<div class="row align-items-end justify-content-end h-100">
										<div class="col-half-section col-half-section-left">
											<div class="row">
												<div class="col">
													<div></div>
													<h1 class="font-weight-extra-bold text-color-light text-md-10 text-lg-12 line-height-2 mb-4 pb-2 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="1400">
														KH 사이버 대학교에 <br> 오신 것을 환영합니다.
													</h1>
													<!--  홈페이지 이동 버튼 -->
													<a href="main.do" class="btn btn-dark font-weight-bold text-3 rounded-0 px-5 btn-py-3 align-items-center d-inline-flex">
														홈페이지로 이동하기
														<i class="fas fa-arrow-right text-5 ml-3"></i>
													</a>
													<p></p>
												</div>
											</div>
											...
											<div class="row">
												<div class="col">
													...
													<div class="appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="1800">
														<!--  학사페이지 이동 버튼 -->
														<a href="login_page.do" class="btn btn-dark font-weight-bold text-3 rounded-0 px-5 btn-py-3 align-items-center d-inline-flex">
															학사페이지 이동하기
															<i class="fas fa-arrow-right text-5 ml-3"></i>
														</a>
													</div>

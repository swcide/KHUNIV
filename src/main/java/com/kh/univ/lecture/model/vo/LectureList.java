...
public class LectureList extends LectureClass {
	...
	public String toString() {
		return "LectureList [credit=" + credit + ", classType=" + classType + ", lecName="  + ", classNo=" + classNo + ", className="
				+ className + ", lecAttendance=" + lecAttendance + ", lecLearningRate=" + lecLearningRate + ", Attendees=" + Attendees
				+ ", classSummary=" + classSummary + ", classImg=" + classImg + ", profName=" + profName + ", profEmail=" + profEmail + ", deptName="
				+ deptName + "]";
	}
